...
insert into public.missions (
  ...
  ('mission-w24-04', 'world-24', 'campaign-24a', 'operation-24a-2', 'score-versus-reach', 'Score Versus Reach', 'A 9.8 sitting behind three closed doors matters less than a 6.1 an attacker can actually reach right now.', 'beginner', ARRAY['zayn'], '{"requiredMissionIds":["mission-w24-03"]}'::jsonb, null, '{"type":"simulation","simulationId":"prioritization-sim"}'::jsonb, '{"xp":100,"credits":15}'::jsonb, false, 4),
  ('mission-w24-05', 'world-24', 'campaign-24a', 'operation-24a-2', 'the-blast-radius', 'The Blast Radius', 'Every patch has a blast radius. Deploying blind because a score is scary is how you cause your own outage.', 'beginner', ARRAY['byte'], '{"requiredMissionIds":["mission-w24-04"]}'::jsonb, null, '{"type":"simulation","simulationId":"patch-impact-sim"}'::jsonb, '{"xp":90,"credits":15}'::jsonb, false, 5),
