...
insert into public.missions (
  ...
  ('mission-w16-02', 'world-16', 'campaign-16a', 'operation-16a-1', 'pipe-the-signal', 'Pipe the Signal', 'A status log is capturing every state change faster than anyone could read it by eye. Filter it, do not scroll it.', 'beginner', ARRAY['zayn'], '{"requiredMissionIds":["mission-w16-01"]}'::jsonb, null, '{"type":"simulation","simulationId":"cluster-watch-pipeline-sim"}'::jsonb, '{"xp":90,"credits":15}'::jsonb, false, 2),
  ...
  ('mission-w16-04', 'world-16', 'campaign-16a', 'operation-16a-2', 'filter-objects-not-text', 'Filter Objects, Not Text', 'PowerShell pipelines pass objects, not lines of text. Filter by property, not by string matching.', 'beginner', ARRAY['zayn'], '{"requiredMissionIds":["mission-w16-03"]}'::jsonb, null, '{"type":"simulation","simulationId":"powershell-pipeline-sim"}'::jsonb, '{"xp":100,"credits":15}'::jsonb, false, 4),
